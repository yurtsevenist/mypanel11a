      ...
      <form  method="POST" action="{{route('blogPost')}}" enctype="multipart/form-data">
       ...
       <div class="row">
         <div class="col-md-8 offset-md-2">
          ...
          <img class="img-fluid text-center" src=""  alt="" srcset="">
          </div>
          <div class="form-group">
            <label for="title">Resim Dosyası</label>
          ...
          <textarea id="summernote" class="form-control" rows="5" name="content" required>{{old('content')}}</textarea>
          </div>
           <button type="submit" class="btn btn-block btn-primary mt-2 mb-2">Ekle</button>
         </div>
